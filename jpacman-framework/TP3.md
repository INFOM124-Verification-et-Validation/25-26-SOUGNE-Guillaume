...
|                 |             |           |         |              |                          |                                   |              |         |           |                             |
|-----------------|-------------|-----------|---------|--------------|--------------------------|-----------------------------------|--------------|---------|-----------|-----------------------------|
| **Collider**    | Ghost       | Ghost     | Ghost   | Ghost        | Ghost                    | Player                            | Player       | Player  | Player    | Wall - Empty Space - Pellet |
| **Collidee**    | Pellet      | Player    | Wall    | Empty Cell   | Empty Cell (from Pellet) | Pellet                            | Empty Cell   | Wall    | Ghost     | Wall - Empty Space - Pellet |
| **Consequence** | Hide Pellet | Game Over | Nothing | Move to Cell | Display Pellet           | Remove Pellet and add 10 to Score | Move to Cell | Nothing | Game Over | Nothing                     |
